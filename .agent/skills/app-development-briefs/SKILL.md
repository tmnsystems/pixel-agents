...
description: Standard operational procedures and guidelines for developing new applications, extensions, and software tools. Use when the user requests to build a new app, extension, or script.
---
