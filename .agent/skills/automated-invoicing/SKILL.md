...
description: Generates highly branded invoices and other business documents via AI-driven spreadsheet injection. Automatically applies colors, fonts, structural components, and mathematical logic from brand guidelines.
---
