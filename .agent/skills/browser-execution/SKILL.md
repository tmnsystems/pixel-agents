...
description: Enables Claude to execute tasks directly via Chrome browser with mandatory audit logging. Claude can generate images via Gemini, access tools requiring authentication, and create assets directly. Requires non-admin service accounts with provisioned privileges. One unlogged action results in permanent access revocation.
---
